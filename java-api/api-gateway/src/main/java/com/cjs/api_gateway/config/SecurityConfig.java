        ...
        public SecurityWebFilterChain springSecurityFilterChain(ServerHttpSecurity http) {
                ...
                return http
                                ...
                                .authorizeExchange(ex -> ex
                                                ...
                                                .pathMatchers(HttpMethod.GET, "/api/mcq", "/api/mcq/**").permitAll()
                                                .pathMatchers(HttpMethod.POST, "/api/mcq").hasAnyRole("ADMIN")
                                                .pathMatchers(HttpMethod.PUT, "/api/mcq/**").hasAnyRole("ADMIN")
                                                .pathMatchers(HttpMethod.DELETE, "/api/mcq/**").hasAnyRole("ADMIN")
